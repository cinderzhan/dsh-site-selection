window.__ModuleLoader__.load({ id: 'dsh-site-selection', factory: (require) => {
  ...
  function apply(ctx) {
    ...
    ctx.effect(() => ctx.desktopWorkbenches.register({
      ...
      initialization: 'empty', embedded: true, version: '1.1.1', author: 'DataElement', layout: { businessSide: 'left', businessWidth: 0.65 },
    }, Panel))
  }

  module.exports = { inject, apply, businessMessage, acceptedMessage, fillDraft, openProject, followSession }
